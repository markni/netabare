...
import { BLACK, BLUE, COLORS10, COLORS10_VIVID_SORTED, IVORY } from '@/constants/colors';
...
const scoreColors = computed(() => (props.useThemePalette ? COLORS10_VIVID_SORTED : COLORS10));
