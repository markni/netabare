...
<template>
  <div
    class="pointer-events-none absolute inset-x-0 top-0 z-50 flex h-5 justify-center overflow-hidden bg-background opacity-80 shadow-sm"
    :style="tracingPaperStyle"
    aria-hidden="true"
  >
    <div class="tracing-paper-texture" aria-hidden="true"></div>
    <span class="mr-2 -translate-x-px bg-gold text-4xl font-bold sm:text-6xl">{{ year }}</span>
  </div>
</template>
